...
contract FederatedLearningContract {
    ...
    event ModelUpdated(uint taskId, address clientAddress, string modelHash, string clientSignature, string ipfsId);
    ...
    function updateModel(uint taskId, string memory modelHash, string memory clientSignature, string memory ipfsId) external {
        // Validate inputs (add more validation as needed)
        ...
        emit ModelUpdated(taskId, clientAddress, modelHash, clientSignature, ipfsId);
    }
