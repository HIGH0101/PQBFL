...
def run_server(server_eth_key, contract_address, server_path, project_id):
    cmd = f"python {server_path} {server_eth_key} {contract_address} {project_id}"
    subprocess.call(cmd, shell=True)
...
if __name__ == "__main__":
    ...
    if args.mode == "client":
        ...
        run_server(server_eth_key, args.contract_address, server_path, args.project_id)
