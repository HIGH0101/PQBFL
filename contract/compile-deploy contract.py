...
if not web3.is_connected():
    ...
    # get bytecode
    contract_bytecode = compiled_sol["contracts"]["contract.sol"]["FederatedLearningContract"]["evm"]["bytecode"]["object"]
    # get abi
    contract_abi = json.loads(compiled_sol["contracts"]["contract.sol"]["FederatedLearningContract"]["metadata"])["output"]["abi"]
